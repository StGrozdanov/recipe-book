...
const applicationUsersSettingsTemplate = (users, data) => html`
...
export async function adminPanelUsersSettingsPage(ctx) {
    ...
    render(applicationUsersSettingsTemplate(users, data), document.getElementById('admin-root'));
